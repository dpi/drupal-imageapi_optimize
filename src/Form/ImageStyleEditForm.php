...
class ImageStyleEditForm extends ImageStyleFormBase {
   ...
   *   The storage.
   * @param \Drupal\imageapi_optimize\ImageEffectManager $image_effect_manager
   *   The image effect manager service.
   */
  ...
  public function effectSave($form, FormStateInterface $form_state) {
    ...
    if (is_subclass_of($effect['class'], '\Drupal\imageapi_optimize\ConfigurableImageEffectInterface')) {
